...
export const statusColorMap = {
  DONE: "bg-secondary-nemi",
  ERROR: "bg-warning-nemi",
  READY: "bg-button-nemi",
  STARTING: "bg-button-nemi",
  CHUNKING: "bg-button-nemi",
  LOADING: "bg-button-nemi",
  EMBEDDING: "bg-button-nemi",
  INGESTING: "bg-button-nemi",
  NER: "bg-button-nemi",
  EXTRACTION: "bg-button-nemi",
  SUMMARIZING: "bg-button-nemi",
  WAITING: "bg-button-nemi",
};
...
export const LightTheme: Theme = {
  theme_name: "Light",
  title: { text: "Nemi-AI", type: "text", description: "Title" },
  subtitle: {
    text: "Facebook Marketing API Assistant",
    type: "text",
