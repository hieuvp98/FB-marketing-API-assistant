...
const ConfigurationView: React.FC<ConfigurationViewProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-6 items-center justify-between h-min w-full">
      ...
      {/* File List */}
      <div className="bg-bg-alt-nemi rounded-2xl flex flex-col p-6 items-center h-full w-full overflow-auto">
      ...
      <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-6 items-center justify-end h-min w-full">
        <div className="flex gap-3 justify-end">
          ...
          <NemiButton title="Reset" onClick={openResetModal} Icon={MdCancel} />
        </div>
      </div>
      <UserModalComponent
