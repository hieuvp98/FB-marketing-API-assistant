    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-3 items-center justify-end lg:justify-between h-min w-full">
        <div className="hidden lg:flex gap-2 justify-start ">
          <InfoComponent
            tooltip_text="Upload your data through this interface into Nemi-AI. You can select individual files, directories or add URL to fetch data from."
        ...
        <div className="flex gap-3 justify-center lg:justify-end">
          ...
          <div className="dropdown dropdown-hover">
            <label tabIndex={0}>
              <NemiButton title="Directory" Icon={GoFileDirectoryFill} />
            </label>
            <ul
              tabIndex={0}
              className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow"
          ...
          <div className="dropdown dropdown-hover">
            <label tabIndex={0}>
              <NemiButton title="URL" Icon={IoMdAddCircle} />
            </label>
      ...
      {/* File List */}
      <div className="bg-bg-alt-nemi rounded-2xl flex flex-col gap-3 p-6 items-center justify-start h-full w-full overflow-auto">
      ...
      {/* Import Footer */}
      {socketStatus === "ONLINE" ? (
        <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-3 items-center justify-end h-min w-full">
