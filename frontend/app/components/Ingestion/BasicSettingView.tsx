    ...
    return (
      <div className="flex flex-col justify-start gap-3 rounded-2xl p-1 w-full ">
        {selectedFileData && fileMap[selectedFileData].status != "READY" && (
          <div className="divider  text-text-alt-nemi">Import Status</div>
        )}

        <div className="flex flex-col gap-3 text-text-nemi">
          {selectedFileData &&
            Object.entries(fileMap[selectedFileData].status_report).map(
              ([status, statusReport]) => (
                <div className="flex" key={"Status" + status}>
                  <p className="flex min-w-[8vw] gap-2 items-center text-text-nemi">
                  ...
                  <label
                    className={`input flex items-center gap-2 w-full ${statusColorMap[statusReport.status]} bg-bg-nemi`}
                  >
                    <input
                      type="text"
        ...
        <div className="divider text-text-alt-nemi">File Settings</div>
        ...
        <div className="flex gap-2 items-center text-text-nemi">
          ...
          <p className="text-sm text-text-alt-nemi text-start">
        ...
        <div className="divider  text-text-alt-nemi">Metadata</div>

        {/* Metadata */}
        <div className="flex gap-2 justify-between items-center text-text-nemi">
          <p className="flex min-w-[8vw]">Metadata</p>
          <textarea
            className="grow w-full textarea flex items-center gap-2 max-h-64 bg-bg-nemi"
            value={metadata}
        ...
        <div className="divider  text-text-alt-nemi">File Information</div>
        ...
        <div className="divider  text-text-alt-nemi">Ingestion Pipeline</div>
        ...
        <dialog id={"File_Debug_Modal"} className="modal">
          <div className="modal-box min-w-fit">
            ...
            <div className="modal-action">
              <form method="dialog">
                <button className="btn text-text-nemi bg-warning-nemi border-none hover:bg-button-hover-nemi ml-2">
                  Close
                </button>
              </form>
            </div>
