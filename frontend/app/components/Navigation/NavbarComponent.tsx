    ...
    <div className="flex justify-between items-center mb-10">
      ...
      <div className="flex flex-row items-center gap-5">
        ...
        <div className="flex flex-col">
          <p className="text-xl font-bold text-text-nemi">{title}</p>
          <p className="text-sm  text-text-alt-nemi font-light">{subtitle}</p>
        </div>
        <div className="flex md:hidden flex-col items-center gap-3 justify-between">
          <div className="dropdown dropdown-hover">
            <NemiButton Icon={TiThMenu} title="Menu" />
            <ul
              tabIndex={0}
      ...
      <div className="flex flex-row justify-center items-center">
        ...
        <div className="hidden md:flex flex-row items-center gap-3 justify-between">
          ...
          <div
            className={`sm:h-[3vh] lg:h-[5vh] mx-1 hidden md:block bg-text-alt-nemi w-px`}
          ></div>
          <NemiButton
            title={gitHubStars}
            Icon={FaGithub}
