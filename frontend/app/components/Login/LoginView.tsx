...
import { connectToNemi } from "@/app/api";
...
const NemiThree = ({
  ...
  const nemi_model = useGLTF(prefix + model_path);
  ...
  useEffect(() => {
    nemi_model.scene.traverse((child) => {
          ...
          <div className="flex flex-col gap-8 items-center md:items-start justify-center w-4/5">
            <div className="flex flex-col items-center md:items-start gap-2">
              <div className="flex items-center gap-3">
                <p className="font-light text-3xl md:text-4xl text-text-alt-nemi">
                  Welcome to
                </p>
                <p className="font-light text-3xl md:text-4xl text-text-nemi">
                  Nemi-AI
                </p>
              </div>
              {production == "Local" && (
                <p className="text-text-nemi text-base lg:text-lg ">
                  ...
                  <div className="flex flex-col justify-start gap-4 w-full">
                    ...
                    >
                      <div className="flex gap-2 items-center justify-between">
                        <label className="input flex items-center gap-2 border-none shadow-md w-full bg-bg-nemi">
                          <FaDatabase className="text-text-alt-nemi" />
                          <input
                            type="text"
                            name="username"
                            value={qdrantHost}
                        ...
                        {selectedDeployment == "Custom" && (
                          <label className="input flex items-center gap-2 border-none shadow-md bg-bg-nemi">
                            <p className="text-text-alt-nemi text-xs">Port</p>
                            <input
                              type="text"
                              name="Port"
                              value={port}
                      ...
                      <label className="input flex items-center gap-2 border-none shadow-md bg-bg-nemi mt-4">
                        <FaKey className="text-text-alt-nemi" />
                        <input
                          type="password"
            ...
            {errorText && (
              <div className="bg-warning-nemi p-4 rounded w-full h-full overflow-auto">
