...
const VectorView: React.FC<VectorViewProps> = ({
  ...
  const [chunk, setChunk] = useState<NemiChunk | null>(null);
        ...
        <div className="flex w-full items-start justify-between">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2 items-center">
              {isFetching && (
                <div className="flex items-center justify-center text-text-alt-nemi gap-2 h-full">
                  <span className="loading loading-spinner loading-xs lg:loading-sm"></span>
                </div>
              )}
              <p className="text-text-alt-nemi text-xs lg:text-sm font-bold">
                Embedding Model:
              </p>
              <p className="text-text-alt-nemi text-xs lg:text-sm">
                {embedder}
              </p>
            </div>
            <div className="flex gap-1 items-center">
              ...
              <p
                className="text-xs lg:text-sm text-text-alt-nemi truncate max-w-[100px] lg:max-w-[300px]"
            ...
            <div className="flex gap-1 items-center">
              ...
              <p className="text-xs lg:text-sm text-text-alt-nemi">
          ...
          <div className="flex gap-10 items-center justify-between min-w-[20vw]">
            <div className="flex flex-col gap-2 w-full">
              {production != "Demo" && (
                <div className="flex gap-2 items-center justify-between">
                  <p className="text-xs text-text-alt-nemi">
                    Show All Documents
                  </p>
                  <input
                    type="checkbox"
              ...
              <div className="flex gap-2 items-center justify-between">
                <p className="text-xs text-text-alt-nemi">Dynamic Coloring</p>
                <input
                  type="checkbox"
                  className="toggle"
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <div className="dropdown dropdown-bottom flex w-full justify-start items-center">
                <button
                  ...
                  role="button"
                  disabled={true}
                  className="btn btn-sm bg-button-nemi hover:bg-button-hover-nemi text-text-nemi w-full flex justify-start border-none"
                >
              ...
              <div className="flex items-center gap-2 w-full">
                <p className="text-text-alt-nemi text-sm">Zoom</p>
                <input
                  onChange={(e) => {
            ...
            {chunk && (
              <button
                ...
                className="flex btn btn-square border-none text-text-nemi bg-button-nemi hover:bg-warning-nemi gap-2"
              >
                <MdCancel size={15} />
              </button>
            )}
        ...
        >
          {chunk && (
            <div className="flex flex-col p-3 gap-2 w-full">
              <p className="text-text-alt-nemi fond-bold">
                Chunk {chunk.chunk_id}
              </p>
              <p className="text-text-alt-nemi text-sm">{chunk.content}</p>
            </div>
          )}
        </div>
      </div>
