...
import { NemiChunk, ChunksPayload, Theme } from "@/app/types";
...
const ChunkView: React.FC<ChunkViewProps> = ({
  ...
  const [chunks, setChunks] = useState<NemiChunk[]>([]);
  ...
  if (chunks.length == 0) {
    return (
      <div>
        {isFetching && (
          <div className="flex items-center justify-center text-text-nemi gap-2 h-full">
        ...
        <div className="bg-bg-alt-nemi flex flex-col rounded-lg overflow-hidden h-full">
          ...
          <div className="flex-grow overflow-hidden p-3">
            ...
            <div className="overflow-y-auto h-[calc(100%-3rem)]">
              <ReactMarkdown
                className="max-w-[50vw] items-center justify-center flex-wrap md:prose-base sm:prose-sm p-3 prose-pre:bg-bg-alt-nemi"
                components={{
