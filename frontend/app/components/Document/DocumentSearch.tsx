    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-3 items-center justify-between h-min w-full">
        <div className="hidden lg:flex gap-2 justify-start w-[8vw]">
          <InfoComponent
            tooltip_text="Search and inspect different documents imported into Nemi-AI"
            display_text="Search"
          />
        </div>
        ...
        <NemiButton onClick={handleSearch} Icon={FaSearch} />
        <NemiButton
          onClick={clearSearch}
          icon_size={20}
      ...
      {/* Document List */}
      <div className="bg-bg-alt-nemi rounded-2xl flex flex-col p-6 gap-3 items-center h-full w-full overflow-auto">
        ...
        {isFetching && (
          <div className="flex items-center justify-center gap-2">
            <span className="loading loading-spinner loading-sm text-text-alt-nemi"></span>
          </div>
        )}
      ...
      <div className="bg-bg-alt-nemi rounded-2xl flex gap-2 p-4 items-center justify-center h-min w-full">
        <div className="join justify-center items-center text-text-nemi">
          <div className="flex justify-center items-center gap-2 bg-bg-alt-nemi">
            <NemiButton
              title={"Previous Page"}
            ...
            <div className="flex items-center">
              <p className="text-xs text-text-nemi">Page {page}</p>
            </div>
            <NemiButton
              title={"Next Page"}
              onClick={nextPage}
