...
import NemiButton from "@/app/components/Navigation/NemiButton";
...
const SettingsComponent: React.FC<SettingsComponentProps> = ({
  ...
  const renderSettingComponent = (
    ...
    return (
      <div key={title}>
        <div className="flex gap-3 justify-between items-center text-text-nemi">
          <p className="flex min-w-[8vw]">{setting_type.description}</p>
          {setting_type.type === "text" && (
            <label className="input flex items-center gap-2 w-full border-none bg-bg-nemi">
              <input
                type="text"
          ...
          {setting_type.type === "color" && (
            <div className="flex flex-col gap-1 h-[15vh] z-10">
              <label className="input bg-bg-nemi input-sm input-bordered flex items-center gap-2 w-full">
                <input
                  type="text"
                  className="grow"
                  placeholder={title}
          ...
          {setting_type.type === "image" && (
            <div className="flex justify-between gap-4 w-full items-center">
              <div className="flex-grow">
                <label className="input flex items-center text-text-nemi gap-2 w-full border-none bg-bg-nemi">
                  <input
                    type="text"
                    className="grow"
