    ...
    <div className="flex flex-col w-full h-full p-4">
          ...
          <div className="flex flex-col gap-2">
            {suggestions.map((suggestion, index) => (
              <div
                ...
                className="flex items-center justify-between gap-2 p-4 border-2 bg-bg-alt-nemi rounded-xl"
              >
                <div className="flex flex-col items-start justify-start gap-2 w-2/3">
                  ...
                  <p
                    className="text-sm text-text-nemi truncate max-w-full"
      ...
      {suggestions.length > 0 && (
        <div className="flex justify-center items-center gap-2 p-3 bg-bg-alt-nemi">
          ...
          />
          <p className="text-xs flex text-text-nemi">Page {page}</p>
          <NemiButton
            title="Next Page"
            onClick={nextPage}
            className="btn-sm min-w-min max-w-[200px]"
