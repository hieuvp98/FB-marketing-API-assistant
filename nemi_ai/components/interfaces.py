...
from nemi_ai.server.types import FileConfig
...
class NemiComponent:
    """
    Base Class for Nemi-AI Readers, Chunkers, Embedders, Retrievers, and Generators.
    """
...
class Reader(NemiComponent):
    """
    Interface for Nemi-AI Readers.
    """
    ...
    async def load(self, config: dict, fileConfig: FileConfig) -> list[Document]:
        """Convert fileConfig into Nemi-AI Documents
        @parameter: fileConfig: FileConfig - FileConfiguration sent by the frontend
        @returns list[Document] - Nemi-AI documents
        """
        raise NotImplementedError("load method must be implemented by a subclass.")


class Embedding(NemiComponent):
    """
    Interface for Nemi-AI Embedder Components.
    """
...
class Chunker(NemiComponent):
    """
    Interface for Nemi-AI Chunking.
    """
    ...
    async def chunk(
        ...
        """Split Nemi-AI documents into chunks.
        @parameter: config : dict - Chunker Configuration
        @parameter: documents : list[Document] - List of Nemi-AI documents to chunk
...
class Retriever(NemiComponent):
    """
    Interface for Nemi-AI Retrievers.
    """
