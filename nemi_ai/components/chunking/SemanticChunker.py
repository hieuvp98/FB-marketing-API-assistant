...
from nemi_ai.components.chunk import Chunk
from nemi_ai.components.interfaces import Chunker
...
class SemanticChunker(Chunker):
    """
    SemanticChunker for Nemi-AI based on https://github.com/FullStackRetrieval-com/RetrievalTutorials/blob/main/tutorials/LevelsOfTextSplitting/5_Levels_Of_Text_Splitting.ipynb
    """
