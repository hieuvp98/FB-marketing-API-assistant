...
from nemi_ai.components.interfaces import Reader
from nemi_ai.server.types import FileConfig
from nemi_ai.components.reader.BasicReader import BasicReader
from nemi_ai.components.util import get_environment
from nemi_ai.components.types import InputConfig


class FirecrawlReader(Reader):
    """
    FirecrawlReader uses the Firecrawl API to scrape or crawl websites and ingest them into Nemi-AI.
    """
    ...
    def __init__(self):
        ...
        self.name = "Firecrawl"
        self.type = "URL"
        self.description = "Use Firecrawl to scrape websites and ingest them into Nemi-AI"
        self.config = {
            "Mode": InputConfig(
                type="dropdown",
                value="Scrape",
